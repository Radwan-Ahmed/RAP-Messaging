...
import com.example.rapmessaging.network.ApiClient;
import com.example.rapmessaging.network.ApiService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(meetingType != null){
            if (meetingType.equals("video")){
                ...
                imageMeetingType.setImageResource(R.drawable.audio_call);
            }
        }
        ...
        textUserName.setText(String.format("%s", name));
